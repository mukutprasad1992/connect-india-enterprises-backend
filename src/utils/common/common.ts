...
export const collaboratorEmailSentSucessfully =
...
export const hereIsYourVoucherTicketDetails =
  ' Here is your voucher ticket details:';
...
export const serviceStatus =
  'Received Your Request at Connect India Enterprises!';
...
export const yourServiceRequestCreatedSuccessfully =
  'Your service request has been created successfully';
export const blockedSubjects =
  'Notice: Block Applied to Your Collaborator Account';
export const unblockedSubjects =
  'Welcome back! Your account access has now been unblocked.';
export const serviceRequestHasBeenDeleted = 'Service Request Has Been Deleted';
export const yourServiceRequestUpdatedSuccessfully =
