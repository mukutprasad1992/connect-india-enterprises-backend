...
import { welcomeEmailSubject } from '../template/welcomeEmailForNormalUser';
import {
...
export class VoucherMailService {
  ...
  async sendVoucherEmailToCustomerCreated(voucherDetails) {
    try {
      ...
      const subject = welcomeEmailSubject;
      const template =
        await sendEmailToCustomerForVoucherCreated(voucherDetails);
  ...
  async generateVoucherPdf(voucherData: any): Promise<string> {
    try {
      ...
      page.drawImage(logoRupeesImage, {
        x: 85,
        y: height - 211,
        width: 8,
        height: 8,
      ...
      // contact icon
      const logoContact = path.resolve(
        __dirname,
        '..',
        '..',
        'iconscontact.png',
      ...
      // address icon
      const logoAddressPath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconsaddress.png',
      ...
      // phone icon
      const logoPhonePath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconsphone.png',
      ...
      // email icon
      const logoEmailPath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconsemail.png',
      ...
      // pincode icon
      const logoPinCodePath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconspincode.png',
      ...
      // Support icon
      const logoSupportPath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconsonlinesupport.png',
      );
      ...
      const logoResolutionPath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconsclock.png',
      ...
      //
      const logoMultilingualPath = path.resolve(
        __dirname,
        '..',
        '..',
        'iconscallmessage.png',
      );
      ...
      const logoMultilingualImage = await pdfDoc.embedPng(
        logoMultilingualBytes,
      );
      // Fonts
      ...
      page.drawText(`Hey ${voucherData.customerName}`, {
        x: 50,
        y: height - 150,
        size: 9,
        font: fontRegular,
      ...
      const remainingTextWidth = fontRegular.widthOfTextAtSize(
        remainingText,
        9,
      );
      ...
      page.drawText(remainingText, {
        x: startX + regularTextWidth + boldTextWidth,
        y: startY,
        size: 9,
        font: fontRegular,
        color: blackColor,
      ...
      page.drawText(`${voucherData.amount}/-`, {
        x: 94,
        y: height - 210,
        size: 9,
        font,
      ...
      const regularVoucherTextWidth = fontRegular.widthOfTextAtSize(
        regularVoucherText,
        9,
      );
      const boldVoucherTextWidth = font.widthOfTextAtSize(boldVoucherText, 9);
      const remainingVoucherTextWidth = fontRegular.widthOfTextAtSize(
        remainingVoucherText,
        9,
      );
      ...
      page.drawText(regularVoucherText, {
        x: startVoucherX,
        y: startVoucherY,
        size: 9,
        font: fontRegular,
      ...
      page.drawText(boldVoucherText, {
        x: startVoucherX + regularVoucherTextWidth,
        y: startVoucherY,
        size: 9,
        font: font,
        color: rgb(0, 0.5, 0),
      });
      page.drawText(remainingVoucherText, {
        x: startVoucherX + regularVoucherTextWidth + boldVoucherTextWidth + 1,
        y: startVoucherY,
        size: 9,
        font: fontRegular,
        color: blackColor,
      ...
      page.drawImage(logoContactImage, {
        x: 116,
        y: height - 367,
        width: 9,
        height: 9,
      });
      page.drawText(`${voucherData.vendorBusinessName}`, {
        x: 135,
        y: height - 365,
        size: 9,
        font: fontRegular,
      ...
      page.drawImage(logoEmailImage, {
        x: 333,
        y: height - 367,
        width: 12,
        height: 12,
      });
      page.drawText(`${voucherData.vendorEmail}`, {
        x: 350,
        y: height - 365,
        size: 9,
        font: fontRegular,
      ...
      page.drawImage(logoPhoneImage, {
        x: 117,
        y: height - 397,
        width: 11,
        height: 11,
      });
      page.drawText(`${voucherData.vendorMobileNo}`, {
        x: 135,
        y: height - 395,
        size: 9,
        font: fontRegular,
      ...
      page.drawImage(logoAddressImage, {
        x: 333,
        y: height - 397,
        width: 11,
        height: 11,
      ...
      page.drawImage(logoPinCodeImage, {
        x: 117,
        y: height - 427,
        width: 11,
        height: 11,
      });
      page.drawText(`${voucherData.vendorPincode}`, {
        x: 135,
        y: height - 425,
        size: 9,
        font: fontRegular,
      ...
      page.drawText(`${voucherData.customerName}`, {
        x: 135,
        y: height - 495,
        size: 9,
        font: fontRegular,
      ...
      page.drawText(`${voucherData.customerEmail}`, {
        x: 350,
        y: height - 495,
        size: 9,
        font: fontRegular,
      ...
      page.drawText(`${voucherData.customerPhone}`, {
        x: 135,
        y: height - 525,
        size: 9,
        font: fontRegular,
      ...
      let customerAddress = voucherData.customerAddress
        .trim()
        .replace(/\s+/g, ' ');
      let customerFirstLine = customerAddress.substring(
        0,
        customerMaxLineLength,
      );
      let customerSecondLine = customerAddress.substring(
        customerMaxLineLength,
        customerMaxLineLength * 2,
      );
      let customerThirdLine = customerAddress.substring(
        customerMaxLineLength * 2,
        customerMaxLineLength * 3,
      );
      let customerfourthLine = customerAddress.substring(
        customerMaxLineLength * 3,
        customerMaxLineLength * 4,
      );
      ...
      page.drawText(`${voucherData.customerPincode}`, {
        x: 135,
        y: height - 555,
        size: 9,
        font: fontRegular,
      ...
      page.drawText(connectIndia, {
        x: startnX + needhelpWidth,
        y: startnY,
        size: 9,
        font: font,
        color: brownColor,
      });
      page.drawText(isHereForYou, {
        x: startnX + needhelpWidth + isHereForYouWidth,
        y: startnY,
        size: 9,
        font: fontRegular,
        color: blackColor,
      ...
      page.drawImage(logoSupportImage, {
        x: 115,
        y: height - 696,
        width: 13,
        height: 13,
      });
      page.drawImage(logoResolutionImage, {
        x: 235,
        y: height - 696,
        width: 13,
        height: 13,
      });
      page.drawImage(logoMultilingualImage, {
        x: 345,
        y: height - 696,
        width: 14,
        height: 14,
