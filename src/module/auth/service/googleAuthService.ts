...
export class GoogleAuthService {
    ...
    async login(oauthUser: any): Promise<any> {
        ...
        this.logger.doLog(`${googleLoginRequestReceivedEmail} ${email}, providerId: ${providerId}`, 'success');
        ...
        try {
            ...
            this.logger.doLog(`${errorInGoogleLoginEmail} ${email}, providerId: ${providerId}, Error: ${error.message}`, 'fail');
            return {
                status: false,
