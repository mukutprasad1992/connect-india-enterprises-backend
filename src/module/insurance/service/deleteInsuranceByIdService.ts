...
export class DeleteInsuranceByIdService {
    ...
    async deleteInsuranceById(id: number, userId: number): Promise<any> {
        ...
        try {
            ...
            const { email, ledgerType, userId: serviceRequestUserId } = getUserIdByInsuranceId[0];
            ...
            const sendEmailToUser =
                await this.deleteServiceTypeByUserSendMailService.deleteSirviceTypeSendEmail(email, ledgerType);
