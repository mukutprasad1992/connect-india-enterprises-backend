...
import { anErrorOccurredWhileDeletingServiceSubType, byUserID, deletedSuccessfullyByUserID, errorDeletingServiceSubTypeID, failedToDeleteServiceSubTypeID, requestedToDeleteServiceSubTypeID, serviceSubTypeID } from '../common/serviceSubTypeMessage';
...
export class DeleteServiceSubTypeByIdController {
    ...
    async deleteServiceSubType(@Param('id') id: number, @Req() req, @Res() res) {
        ...
        this.logger.doLog(`User ID: ${userId} ${requestedToDeleteServiceSubTypeID} ${id}`, 'info');
