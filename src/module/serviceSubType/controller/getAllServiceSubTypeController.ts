...
import { allServiceSubTypesFetchedSuccessfullyByUserID, anErrorOccurredWhileRetrievingServiceSubType, errorOccurredWhileFetchingAllServiceSubFypesForUserID, failedToFetchAllServiceSubTypesReason, requestedAllServiceSubTypes } from '../common/serviceSubTypeMessage';
...
export class GetAllServiceSubTypeController {
    ...
    async GetAllServiceSubType(@Res() res, @Req() req) {
        ...
        this.logger.doLog(`User ID: ${userId} ${requestedAllServiceSubTypes}`, 'info');
