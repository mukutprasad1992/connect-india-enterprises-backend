...
import { errorUpdatingLoan, failedToUpdateLoan, forUser, loanUpdatedSuccessfully, loanUpdateError, updatingLoanWithID } from '../common/loanMessage';
...
export class UpdateLoanByIdController {
    ...
    async updateLoanById(
        ...
        this.logger.doLog(`${updatingLoanWithID} ${id} ${forUser} ${userId}`, 'info');
