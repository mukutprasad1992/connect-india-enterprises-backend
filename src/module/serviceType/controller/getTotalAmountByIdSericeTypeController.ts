...
import { errorFetchingTotalAmountForServiceTypeId, failedToFetchTotalAmountForServiceTypeId, requestedByUserId, requestReceivedGetTotalAmountForServiceTypeId, serviceTypeRetrievalError, totalAmountFetchedSuccessfullyForServiceTypeId } from '../common/serviceTypeMessage';
