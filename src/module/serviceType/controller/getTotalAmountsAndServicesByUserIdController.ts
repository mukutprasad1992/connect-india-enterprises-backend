...
import { errorFetchingTotalAmountServicesForUserId, failedToFetchTotalAmountServicesForUserId, fetchedTotalAmountServicesSuccessfullyForUserId, requestReceivedGetTotalAmountServicesByUserId, serviceTypeRetrievalError } from '../common/serviceTypeMessage';
