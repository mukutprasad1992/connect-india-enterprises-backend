...
import { errorFetchingTotalAmountForServiceId, failedToFetchTotalAmountForServiceId, requestedByUserId, requestReceivedGetTotalAmountForServiceId, serviceTypeRetrievalError, totalAmountFetchedSuccessfullyForServiceId } from '../common/serviceTypeMessage';
