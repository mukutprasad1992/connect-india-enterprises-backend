...
import {
  errorFetchingAllServiceTypesForUserId,
  failedToFetchServiceTypesForUserId,
  fetchedAllServiceTypesSuccessfullyForUserId,
  requestReceivedGetAllServiceTypesForUserId,
