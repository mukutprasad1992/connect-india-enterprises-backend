...
export class CreateServiceController {
  ...
  @Post()
  async createService(
    @Body(new ValidationService(CreateServiceDTO.ServiceSchema))
    ...
    try {
      ...
      const serviceSchemaResponse =
        await this.createServiceService.createService(userId, createServiceDTO);
